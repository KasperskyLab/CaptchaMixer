...
/// <summary>
/// Creates paths consisting of random Bezier curves.
/// </summary>
public class RandomCurves : AreaBasedVectorObjectsCreator
{
	/// <summary>
	/// Paths count.
	/// </summary>
	...
	public override void Process(RectangleF area, IVectorLayer layer, ICaptchaContext context)
	{
		...
		for (var i = 0; vectorObject.Paths.Count < count; i++)
		{
			...
			for (var j = 1; j < points; j++)
				path.Instructions.Add(new CubicToInstruction(GetRandomAreaPoint(), GetRandomAreaPoint(), GetRandomAreaPoint()));
