...
public class AddRectInstructionTests
{
	[Test]
	[TestCase(0, 0, 0, 0, 0, 0, 0, 0)]
	[TestCase(0, 0, 5, 5, 0, 0, 5, 5)]
	[TestCase(0, 0, -5, -5, -5, -5, 5, 5)]
	public void VectorPathInstructions_AddRect_GetBounds_Test(
		float l, float t, float r, float b,
		float lr, float tr, float wr, float hr)
	{
		var instruction = new AddRectInstruction(l, t, r, b);
	...
	[Test]
	public void VectorPathInstructions_AddRect_Clone_Test()
	{
		var lt = new Vector2(0, 0);
		var rb = new Vector2(5, 5);
		var instruction = new AddRectInstruction(lt, rb);
